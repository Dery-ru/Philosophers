...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/12/13 12:38:10 by rhoke             #+#    #+#             */
/*   Updated: 2021/12/13 19:26:22 by rhoke            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	data_init(t_data *data, int argc, char **argv)
{
	...
	sem_unlink("fork");
	sem_unlink("print");
	data->fork_s = sem_open("fork", O_CREAT, 0666, data->ph_count);
	data->print_s = sem_open("print", O_CREAT, 0666, 1);
